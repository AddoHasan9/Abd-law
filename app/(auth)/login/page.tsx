...
export default function LoginPage() {
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center p-4 md:p-8 bg-[#090D16] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[960px] rounded-[28px] bg-slate-900/60 backdrop-blur-2xl border border-white/10 shadow-2xl shadow-black/80 overflow-hidden grid grid-cols-1 lg:grid-cols-12 animate-fade-in-up">
        {/* ============ Brand Presentation Panel (Right on Desktop, Top on Mobile) ============ */}
        <aside className="lg:col-span-5 bg-gradient-to-b from-slate-800/50 via-slate-900/70 to-slate-950/80 p-8 md:p-10 flex flex-col justify-between border-b lg:border-b-0 lg:border-l border-white/10 relative overflow-hidden text-right">
        ...
        <section className="lg:col-span-7 p-8 md:p-12 flex items-center justify-center bg-slate-950/40">
          <LoginForm />
        </section>
      </div>
    </main>
